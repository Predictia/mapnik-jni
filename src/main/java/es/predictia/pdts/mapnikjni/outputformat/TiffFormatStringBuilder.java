package es.predictia.pdts.mapnikjni.outputformat;
...
public class TiffFormatStringBuilder extends FormatStringBuilderBase {
	...
	public TiffFormatStringBuilder withZLevel(int zLevel) {
		if (zLevel < 0 || zLevel > 9) {
			throw new IllegalArgumentException("Invalid zLevel. Expected: 0..9, actual: " + zLevel);
		}
	...
	public TiffFormatStringBuilder withTileHeight(int tileHeight) {
		if (tileHeight < 0) {
			throw new IllegalArgumentException("Invalid tileHeight. Expected: non-negative, actual: " + tileHeight);
		}
	...
	public TiffFormatStringBuilder withTileWidth(int tileWidth) {
		if (tileWidth < 0) {
			throw new IllegalArgumentException("Invalid tileWidth. Expected: non-negative, actual: " + tileWidth);
		}
	...
	public TiffFormatStringBuilder withRowsPerStrip(int rowsPerStrip) {
		if (rowsPerStrip < 0) {
			throw new IllegalArgumentException("Invalid rowsPerStrip. Expected: non-negative, actual: " + rowsPerStrip);
		}
